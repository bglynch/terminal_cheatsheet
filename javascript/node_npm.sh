...
echo -e "${tl}                                                                      ${z}"
echo -e "NVM"
echo -e "  ${c}nvm ls-remote                     ${d}list available versions of NodeJs"
echo -e "  ${c}nvm ls                            ${d}list local versions of NodeJs"
echo -e "  ${c}nvm install 0.12.3                ${d}Install a version of NodeJs"
echo -e "  ${c}nvm use 14                        ${d}Switch to a general release of NodeJs"
echo -e "  ${c}nvm use 0.12.3                    ${d}Switch to specific version of NodeJs"
echo -e "  ${c}nvm current                       ${d}Current version of NodeJs"
echo -e "NPM"
echo -e "${z}- Start Project"
