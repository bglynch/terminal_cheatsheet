...
echo -e "${TEXT01}Kill on a port 3000(allows clean up):  ${RESET} \t${TX_YELLOW}kill -15 <PID>${RESET}" 
echo -e "${TEXT01}Kill on a port 3000:                   ${RESET} \t${TX_YELLOW}kill -9 <PID>${RESET}" 
...
echo -e "${TEXT01}Find a file:                           ${RESET} \t${TX_YELLOW}find ~/ -name \"*.err\"${RESET}" 
